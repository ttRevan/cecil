...
namespace SquabPie.Mono.Cecil.Tests {
	...
	public class ImportCecilTests : BaseTestFixture {
		...
		public void ImportMethodOnOpenGeneric ()
		{
			...
			Assert.AreEqual ("T SquabPie.Mono.Cecil.Tests.ImportCecilTests/Generic`1::Method(T)", method.FullName);
		}
		...
		public void ContextGenericTest ()
		{
			...
			Assert.AreEqual ("G1 SquabPie.Mono.Cecil.Tests.ImportCecilTests/ContextGeneric1Method2`1<SquabPie.Mono.Cecil.Tests.ImportCecilTests/ContextGeneric2Method1`2<G2,H2>>::GenericMethod<R1,S1>(R1,S1)", method.FullName);
			...
			Assert.AreEqual ("R2 SquabPie.Mono.Cecil.Tests.ImportCecilTests/ContextGeneric2Method1`2<SquabPie.Mono.Cecil.Tests.ImportCecilTests/ContextGeneric1Method2`1<G1>,System.Collections.Generic.IList`1<T>>::GenericMethod<R2>(G2,H2)", method.FullName);
			...
			imported_type = module.Import (type);
			method = module.Import (meth, imported_type);
			Assert.AreEqual ("A SquabPie.Mono.Cecil.Tests.ImportCecilTests/NestedGenericsA`1/NestedGenericsB`1/NestedGenericsC`1<System.String,System.Int32,System.Single>::GenericMethod(B,C)", method.FullName);
			...
			imported_type = module.Import (type);
			method = module.Import (meth, imported_type);
			Assert.AreEqual ("SquabPie.Mono.Cecil.Tests.ImportCecilTests/Generic`1<TS> SquabPie.Mono.Cecil.Tests.ImportCecilTests/Generic`1<System.String>::ComplexGenericMethod<TS>(T,TS)", method.FullName);
		}
