...
namespace SquabPie.Mono.Cecil.Tests {
	...
	public class ImportReflectionTests : BaseTestFixture {
		...
		public void ImportGenericTypeDefOrOpen ()
		{
			...
			Assert.AreEqual ("SquabPie.Mono.Cecil.Tests.ImportReflectionTests/Foo`1", foo_def.FullName);
			Assert.AreEqual ("SquabPie.Mono.Cecil.Tests.ImportReflectionTests/Foo`1<TFoo>", foo_open.FullName);
		}
		...
		public void ImportGenericTypeFromContext ()
		{
			...
			Assert.AreEqual ("SquabPie.Mono.Cecil.Tests.ImportReflectionTests/Generic`1<System.Collections.Generic.List`1<TFoo>>",
		...
		public void ImportGenericTypeDefFromContext ()
		{
			...
			Assert.AreEqual ("SquabPie.Mono.Cecil.Tests.ImportReflectionTests/Generic`1<SquabPie.Mono.Cecil.Tests.ImportReflectionTests/Foo`1<TFoo>>",
				generic_foo.FullName);
		}
		...
		public void ImportArrayTypeDefFromContext ()
		{
			...
			Assert.AreEqual ("SquabPie.Mono.Cecil.Tests.ImportReflectionTests/Foo`1<TFoo>[]",
				array_foo.FullName);
		}
		...
		public void ImportGenericFieldFromContext ()
		{
			...
			Assert.AreEqual ("T SquabPie.Mono.Cecil.Tests.ImportReflectionTests/Generic`1<System.Collections.Generic.List`1<TFoo>>::Field",
		...
		public void ImportGenericMethodFromContext ()
		{
			...
			Assert.AreEqual ("T SquabPie.Mono.Cecil.Tests.ImportReflectionTests/Generic`1<System.Collections.Generic.List`1<TFoo>>::Method(T)",
		...
		public void ImportMethodOnOpenGenericType ()
		{
			...
			Assert.AreEqual ("T SquabPie.Mono.Cecil.Tests.ImportReflectionTests/Generic`1<T>::Method(T)", method.FullName);
		}
		...
		public void ImportGenericMethodOnOpenGenericType ()
		{
			...
			Assert.AreEqual ("TS SquabPie.Mono.Cecil.Tests.ImportReflectionTests/Generic`1<T>::GenericMethod(T,TS)", generic_method.FullName);

			generic_method = module.Import (typeof (Generic<>).GetMethod ("GenericMethod"), generic_method);

			Assert.AreEqual ("TS SquabPie.Mono.Cecil.Tests.ImportReflectionTests/Generic`1<T>::GenericMethod<TS>(T,TS)", generic_method.FullName);
		}
