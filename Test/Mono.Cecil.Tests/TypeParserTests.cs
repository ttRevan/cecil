...
namespace SquabPie.Mono.Cecil.Tests {
	...
	public class TypeParserTests : BaseTestFixture {
		...
		public void SimpleTypeDefinition ()
		{
			...
			const string fullname = "SquabPie.Mono.Cecil.Tests.TypeParserTests";

			var type = TypeParser.ParseType (module, fullname);
			Assert.IsNotNull (type);
			Assert.AreEqual (module, type.Scope);
			Assert.AreEqual (module, type.Module);
			Assert.AreEqual ("SquabPie.Mono.Cecil.Tests", type.Namespace);
		...
		{
			var module = GetCurrentModule ();
			var cecil = module.AssemblyReferences.Where (reference => reference.Name == "SquabPie.Mono.Cecil").First ();

			var fullname = "SquabPie.Mono.Cecil.TypeDefinition, " + cecil.FullName;

			var type = TypeParser.ParseType (module, fullname);
			Assert.IsNotNull (type);
			Assert.AreEqual (cecil, type.Scope);
			Assert.AreEqual (module, type.Module);
			Assert.AreEqual ("SquabPie.Mono.Cecil", type.Namespace);
		...
		public void SimpleNestedType ()
		{
			...
			const string fullname = "SquabPie.Mono.Cecil.Tests.TypeParserTests+ID";
			...
			Assert.AreEqual ("SquabPie.Mono.Cecil.Tests.TypeParserTests/ID", type.FullName);
		...
		public void GenericInstanceMixedArguments ()
		{
			...
			var fullname = string.Format ("System.Collections.Generic.Dictionary`2[SquabPie.Mono.Cecil.Tests.TypeParserTests,[System.String, {0}]]",
				typeof (object).Assembly.FullName);
			...
			Assert.AreEqual (module, argument.Module);
			Assert.AreEqual ("SquabPie.Mono.Cecil.Tests", argument.Namespace);
		...
		public void GenericInstanceTwoNonFqArguments ()
		{
			...
			var fullname = string.Format ("System.Collections.Generic.Dictionary`2[SquabPie.Mono.Cecil.Tests.TypeParserTests+Bar,SquabPie.Mono.Cecil.Tests.TypeParserTests+Bar], {0}", typeof (object).Assembly.FullName);
		...
		public void ComplexGenericInstanceMixedArguments ()
		{
			...
			var fullname = string.Format ("System.Collections.Generic.Dictionary`2[[System.String, {0}],SquabPie.Mono.Cecil.Tests.TypeParserTests+Foo`2[SquabPie.Mono.Cecil.Tests.TypeParserTests,[System.Int32, {0}]]]",
				typeof (object).Assembly.FullName);
			...
			Assert.AreEqual ("SquabPie.Mono.Cecil.Tests.TypeParserTests/Foo`2", instance.ElementType.FullName);
